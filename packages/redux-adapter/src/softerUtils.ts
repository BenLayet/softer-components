...
export const mapComponentTree = (componentDef: ComponentDef<any, any, any, any>, name: string = "/"): Record<string, ComponentDef> => {
...
export const initialStateFromComponentMap = (componentDef: Record<string, ComponentDef<any, any, any, any>>): Record<string, State> => {
