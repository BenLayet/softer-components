import { ExtractComponentValuesContract, Selectors, State } from "@softer-components/types";
...
export const selectors = {
  isAuthenticated: (_, __, { userContext }) => userContext.values.isAuthenticated(),
  isAnonymous: (_, __, { userContext }) => !userContext.values.isAuthenticated(),
